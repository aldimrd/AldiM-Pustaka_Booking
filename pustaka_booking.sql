...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 22, 2021 at 12:02 AM
...
CREATE TABLE `buku` (
  ...
  `pengrang` varchar(64) CHARACTER SET latin1 NOT NULL,
  ...
  `sttok` int(11) NOT NULL,
  `dipinjam` int(11) NOT NULL,
  `dibooking` int(11) NOT NULL,
  `image` varchar(256) DEFAULT 'book_default-cover'
...
INSERT INTO `buku` (`id`, `judul_buku`, `id_kategori`, `pengrang`, `penerbit`, `tahun_penerbit`, `isbn`, `sttok`, `dipinjam`, `dibooking`, `image`) VALUES
...
(10, 'Detektif Conan Ep 200', 9, 'Okigawa Sasuke', 'Cultura', 2016, '874387583987', 5, 0, 0, 'img1557402703.jpg'),
